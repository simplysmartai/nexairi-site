        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          ...
          <div className="lg:col-span-8">
            <div className="mb-6 flex items-center gap-3">
               ...
               <span className="text-brand-cyan font-mono text-sm uppercase tracking-widest">Cover Story</span>
            </div>
            
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold text-white tracking-tighter leading-[0.9] mb-8">
              {post.title}
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed max-w-2xl border-l-4 border-brand-cyan pl-6 mb-10">
              {post.excerpt}
            </p>
